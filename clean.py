...
def clean_flats():
    flats = pd.read_excel("gs://mk-dev-gcs/data/flat_prices.xlsx", header=6, sheet_name="Rynek pierwotny")
    ...
    flats_unpivot.to_parquet("gs://mk-dev-gcs/data/flats_price.parquet")

def clean_salary():
    fs = gcsfs.GCSFileSystem()
    fs.put("data/salary.csv","gs://mk-dev-gcs/data/salary.csv")
    salary = pd.read_csv("gs://mk-dev-gcs/data/salary.csv")
    ...
    salary.to_parquet("gs://mk-dev-gcs/data/salary.parquet")

def clean_m1():
    pass
#    m1 = pd.read_csv("gs://mk-dev-gcs/data/m1.csv")
...
def clean_currency():
    ...
    gold = pd.read_csv("gs://mk-dev-gcs/data/gold.csv", names=["date","price"], header=None)
    gold2013 = pd.read_csv("gs://mk-dev-gcs/data/gold_2013.csv", names=["date","price"], header=None)
    ...
    usd = pd.read_csv("gs://mk-dev-gcs/data/usd.csv", names=["date","price"], header=None)
    ...
    usd.to_parquet("gs://mk-dev-gcs/data/currency.parquet")
